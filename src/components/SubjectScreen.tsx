...
export const SubjectScreen: React.FC<SubjectScreenProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12 select-none">
      ...
      {/* 2. SUBJECT HEADER HERO */}
      <div
        id="subject-header-hero"
        className="p-6 sm:p-7 rounded-3xl bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-white/70 dark:border-zinc-800/80 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6"
      >
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold px-2 py-0.5 rounded-md bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200/60 dark:border-indigo-800/40 uppercase">
                Kurikulum LKS
              </span>
              <span className="text-xs text-zinc-400">Semester Genap</span>
            </div>
      ...
      <div className="space-y-6">
        {currentSubjectInfo.chapters.map((chapter, chapIdx) => (
          <div
            ...
            className="rounded-3xl bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-white/60 dark:border-zinc-800/80 p-5 sm:p-6 shadow-xs space-y-4"
          >
            {/* Chapter Header */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-100 dark:border-zinc-800">
              ...
              <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 self-start sm:self-center">
                ...
                >
                  <div>
                    <div className="flex items-center justify-between gap-2 mb-1.5">
                      <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-white dark:bg-zinc-700 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-600">
                        {sub.code}
                      </span>
                  ...
                  <div className="mt-3 pt-2.5 border-t border-zinc-200/40 dark:border-zinc-700/40 flex items-center justify-between text-xs text-indigo-600 dark:text-indigo-400 font-semibold">
